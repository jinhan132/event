...
header("Content-Type:text/html;charset=utf-8");
	...
	$sql = "select date_format(yymmdd, '%Y-%m-%d') as yymmdd, dau from system_log where  yymmdd like $size_date  group by date_format(yymmdd, '%Y-%m-%d')";
...
<script language='JavaScript'>
	<!--
		...
		function sendCal(str) {
			...
			document.calForm.action = "idct_dau.html";
			document.calForm.submit();
		}
	//-->
	</script>
