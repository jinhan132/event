...
?>
		<tr>
			<td width="30"><input type="checkbox" name="uid[]" value="<?=$uid?>" onclick="checkbox_in()" <?if($n_code == $ncode_arr[0] || $n_code == $ncode_arr[1] || $n_code == $ncode_arr[2] || $n_code == $ncode_arr[3] || $n_code == $ncode_arr[4]){echo "checked";}?>></td>
			<td width="50"><?=$uid?></td>
